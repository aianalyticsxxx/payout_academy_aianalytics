            ...
            {[
              {
                ...
                tier: '€10K Pro',
                reward: '€8,500',
                quote: 'Стигнах Level 4 на втория опит. Системата ме държи дисциплиниран - без случайни залози. Вече изтеглих €8.5K!',
                rating: 5,
              },
              {
                name: 'Милан Р.',
                ...
                tier: '€5K Beginner',
                reward: '€3,200',
                quote: 'Počeo sam sa Beginner modom da naučim sistem. Niži koeficijenti (1.5x) su učinili strikove mnogo lakšim.',
                rating: 5,
              },
              {
                name: 'Marco R.',
                ...
                tier: '€10K Pro',
                reward: '€9,200',
                quote: 'Finalmente un sistema che funziona! Ho completato tutti i 4 livelli in 3 settimane. Fantastico!',
                rating: 5,
              },
              {
                name: 'Димитър К.',
                ...
                tier: '€25K Pro',
                reward: '€21,000',
                quote: 'Залагам от години, но никога нямах система. Zalogche промени всичко. Наградите на всяко ниво те мотивират.',
                rating: 5,
              },
              {
                name: 'Петър И.',
                ...
                tier: '€1K Beginner',
                reward: '€950',
                quote: 'Перфектно за начало. Ниска входна цена, и дори да загубя стрийка, запазвам наградите които вече спечелих!',
                rating: 5,
              },
              {
                name: 'Драган Н.',
                ...
                tier: '€50K Pro',
                reward: '€45,000',
                quote: 'Rok od 45 dana je odličan. Nema pritiska da žuriš. Završio sam sva 4 nivoa sa 2 nedelje viška.',
                rating: 5,
              },
              {
                name: 'Иван С.',
                ...
                tier: '€5K Pro',
                reward: '€4,800',
                quote: 'Харесва ми че мога да рестартирам стрийка ако сгреша. €10 за рестарт е нищо в сравнение с потенциалните награди.',
                rating: 5,
              },
            ].map((testimonial, i) => (
              <div
